  ...
  <el-collapse-item name="1" title="车辆信息" >
	  <el-form  inline class="expand">
		  	<el-form-item  v-for=" a in carInfo" :key="a.title" :lable="a.title" style="margin:0">
				<label style="min-width:400px;display:inline-block;"><span class="titles">{{a.title}}:</span><span class="lable">{{a.field}}</span></label>	
			</el-form-item>
	  </el-form>			
  </el-collapse-item>	
...
<style>
	...
	.titles{display:inline-block;width:90px;text-align:right;font-size:14px}
