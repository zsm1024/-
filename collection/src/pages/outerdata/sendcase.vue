...
<script >
import {SendList,sendTheCaseApp} from '@/api/outerlist';     
...
export default {
  data(){
      return{  
          ...
          cols: [   { title: '用户ID', field: 'processer', width: "60" },
                    { title: '预派案公司', field: 'escrowUser', width: "60" },
                    { title: '预派案到期日', field: 'escrowTime', width: "60" },
  ...
  methods: {
    ...
    hostList(){
        ...
        console.log(typeof(para.willSendCompany))
