...
<script>
	...
	import { repairlist, repairDetial } from '@/api/tablist';
...
<style >
#WbInfos .el-dialog--small{width:97%!important;max-height:98%;overflow: auto;top:0%!important };
#WbInfos  .el-dialog--small td{color:#269aff!important;font-size: 13px } 
#WbInfos   .el-dialog--small .tds{color: #000!important;} 
</style>