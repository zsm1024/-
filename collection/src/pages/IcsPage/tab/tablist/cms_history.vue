...
export default {
		data() {
			return {
				...
				lists: [],
				cols: [
                    {title:'处理日期',field:'processingDate',width:"100"},
                    {title:'催收结果',field:'collectionResults'},
                    {title:'承诺日期',field:'commitmentDate',width:"100"},
                    {title:'复催日期',field:'recoveryDate',width:"100"},
                    {title:'处理人',field:'handlePerson'},
                    {title:'承诺金额',field:'amountCommitment'},
                    {title:'实地状态',field:'fieldStatus'},
                    {title:'实地日期',field:'fieldDate'},
                    {title:'特殊案件标识',field:'specialIdentification',width:"120"},
                    {title:'代购标识',field:'purchasingLabel'},
                    {title:'代购人姓名',field:'nameAgent'},
                    {title:'代购人身份证',field:'purchasingId',width:"120"},
