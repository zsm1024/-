  ...
  <section>
    ...
    <el-col :span="24" class="toolbar legals" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input
            v-model="filters.applicationNumber"
            placeholder="合同号"
            clearable
            style="width:130px"
          ></el-input>
        ...
        <el-form-item>
          <el-date-picker
            style="width:130px"
            v-model="filters.submissionFilingTime"
            @change="submissionFilingTime"
            type="date"
        ...
        <el-form-item>
          <el-date-picker
            style="width:150px"
            v-model="filters.firstCourtTime"
            @change="firstCourtTime"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="第一次开庭时间"
          ></el-date-picker>
        ...
        <el-form-item>
          <el-input
            v-model="filters.firstInstanceReference"
            placeholder="一审案号"
            clearable
            style="width:130px"
          ></el-input>
    ...
    >
      ...
      <el-table-column label="操作" width="60" fixed="left" align="center">
        <template slot-scope="scope">
          <router-link class="a-href" :to="{path:'/IcsPage/tab/tabview/'+scope.row.missionId}">
            <span @click="setCurrent(scope.$index,scope.row.missionId)">处理</span>
          </router-link>
        </template>
      </el-table-column>
      <el-table-column
