...
import { coMissionApp,cancelEscrow,getTaskHostUser1,listCoMission,positionUser} from '@/api/task';
        ...
        this.multipleSelection.forEach((f,i) =>{
           ...
           if(this.b.indexOf("N",0)==-1){
                let para={
                        ...
                        if(this.AdduserForms.stateCode==""||this.AdduserForms.areaList==""|| this.addlists.length==0||this.times==""){          
